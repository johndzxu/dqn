...
class DQNAgent:
    ...
    def train(self, episodes):
        ...
        for episode in range(1, episodes+1):
            ...
            if (episode+1)%25 == 0:
                torch.save(self.q_net.state_dict(), f"model_params/new_{self.env.spec.name}.params.save")
                logging.info("Model parameters saved.")

        torch.save(self.q_net.state_dict(), f"model_params/new_{self.env.spec.name}.params")
